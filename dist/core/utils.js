...
class Utils {
  ...
  static buildHeaders({ userAgent, csrfToken, referer, extra = {} } = {}) {
    const base = {
      'User-Agent': userAgent || this.formatUserAgent('415.0.0.36.76', 'Pixel 8 Pro', 'en_US', '580610226'),
  ...
  static formatUserAgent(appVersion = '415.0.0.36.76', deviceString = 'Pixel 8 Pro', language = 'en_US', appVersionCode = '580610226') {
  ...
  static createUserAgentFromDevice(device = {}) {
    return `Instagram ${device.appVersion || '415.0.0.36.76'} Android (${device.android_version || device.android_release || '14'}/${device.android_release || '14'}; ${device.dpi || '480'}dpi; ${device.resolution || '1344x2992'}; ${device.manufacturer || 'Google'}; ${device.model || 'Pixel 8 Pro'}; ${device.device || 'husky'}; ${device.cpu || 'arm64-v8a'})`;
  }

...
exports.Topics = {
    ...
    NOTIFY_DISCONNECT: {
        id: '176',
        path: '/notify_disconnect',
        parser: new parsers_1.JsonParser(),
    },
    THREAD_TYPING: {
        id: '195',
        path: '/t_thread_typing',
        parser: new parsers_1.JsonParser(),
    },
    IRIS_SERVER_RESET: {
        id: '141',
        path: '/iris_server_reset',
        parser: new parsers_1.JsonParser(),
    },
    IG_NAVIGATION_BADGE: {
        id: '152',
        path: '/t_ig_family_navigation_badge',
        parser: new parsers_1.JsonParser(),
    },
    ENTITY_PRESENCE: {
        id: '160',
        path: '/t_entity_presence',
        parser: new parsers_1.JsonParser(),
    },
    OPENED_THREAD: {
        id: '139',
...
exports.APP_VERSION = '415.0.0.36.76';
exports.REALTIME = {
